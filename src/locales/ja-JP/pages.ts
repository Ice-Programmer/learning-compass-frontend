export default {
  'pages.layouts.userLayout.title': 'Learning Compassは - 「学びに力を、ワンクリックで」',
  ...
  'pages.login.emailLogin.tab': 'メールログイン',
  'pages.login.emailLogin.errorMessage': '検証コードエラー',
  'pages.login.email.placeholder': 'メールアドレス',
  'pages.login.email.required': 'メールアドレスは必須項目です！',
  'pages.login.email.invalid': 'メールアドレスが無効です！',
  'pages.login.captcha.placeholder': '確認コード',
  'pages.login.captcha.required': '確認コードを入力してください！',
  'pages.login.emailLogin.getVerificationCode': '確認コードを取得',
  'pages.getCaptchaSecondText': '秒',
  'pages.login.rememberMe': 'Remember me',
  'pages.login.register': '登録する',
