export default {
  ...
  'pages.login.logout.success': 'Successfully logged out!',
  ...
  'pages.login.emailLogin.errorMessage': 'Verification Code Error',
  'pages.login.email.placeholder': 'Email Number',
  'pages.register.account.name': 'Account',
  'pages.register.account.user.role': 'User Role',
  'pages.register.step.one': 'User Information',
  'pages.register.step.two': 'Set Password',
  'pages.register.password.name': 'Password',
  'pages.register.password.check': 'Confirm Password',
  ...
  'pages.login.email.invalid': 'Email number is invalid!',
